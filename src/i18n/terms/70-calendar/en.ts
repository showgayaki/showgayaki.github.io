const en = {
    ...
    sections: [
        ...
        {
            title: 'Article 2 (Conditions of Use and Prohibited Acts)',
            paragraphs: [
        ...
        {
            title: 'Article 3 (Intellectual Property Rights)',
            paragraphs: [
        ...
        {
            title: 'Article 4 (Subscriptions and Payments)',
            paragraphs: [
        ...
        {
            title: 'Article 5 (Use of External Services)',
            list: [
        ...
        {
            title: 'Article 6 (Handling of Data)',
            paragraphs: [
        ...
        {
            title: 'Article 8 (Changes or Termination of Services)',
            paragraphs: [
