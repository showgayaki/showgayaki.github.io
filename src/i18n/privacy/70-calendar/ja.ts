        ...
        },
        {
            ...
            subsections: [
                ...
                },
                {
                    title: 'データ保護',
                    paragraphs: [
                        '本アプリとGoogle APIとの通信は、すべてHTTPS（TLS）による暗号化通信を使用します。Google アカウントへのアクセスはOAuthによって制御されており、アプリが取得できる権限はユーザーが同意したスコープのみに限定されます。'
                    ]
                },
                {
                    title: 'データの保持と削除',
                    paragraphs: [
                        '本アプリはGoogleカレンダーデータを外部サーバーに保存しないため、当方が保持するGoogleユーザーデータはありません。データはリアルタイムで処理され、Googleのサーバー上でのみ管理されます。',
                        'ユーザーはいつでも以下のGoogleアカウント設定ページから本アプリのアクセス権を取り消すことができます。アクセス権を取り消すと、本アプリはGoogleアカウントのデータに一切アクセスできなくなります。'
                    ],
                    links: [
                        {
                            label: 'Googleアカウントの権限管理',
